...
func AlerttransactionCredittransfer(c *fiber.Ctx) error {
	...
	exists, err := checktxnidexistalerttransaction(transactions[0].ReferenceId, transactions[0].InstructionId, transactions[0].ReceivingAccount, transactions[0].ReceivingName, transactions[0].SenderAccount, transactions[0].SenderName)
	if err != nil {
