...
func FeedbackCredit(c *fiber.Ctx) error {
	...
	if err := c.BodyParser(network); err != nil {
		//400
		loggers.CreditransferFeedbackLogs(c.Path(), "folderName", UniqueidCredittransfer, "(Method Not Allowed - 400)", "null", requestTrigger, "null", "null", "null", "null", "null", "NETWORK_FINANCIAL_CRIME", "null", "null", "null", "null")
		return errorhandling.Bad_Request(c, "The request contains a bad payload")
	}
	...
	if len(transactions) == 0 {
		//404
		loggers.CreditransferFeedbackLogs(c.Path(), "folderName", UniqueidCredittransfer, "(Method Not Allowed - 404)", "null", requestTrigger, "null", "null", "null", "null", "null", "NETWORK_FINANCIAL_CRIME", "null", "null", "null", "null")
	...
	for i := 0; i < len(transactions); i++ {
		...
		loggers.CreditransferFeedbackLogs(c.Path(), "folderName", UniqueidCredittransfer, message, Instruction_id, requestTrigger, Transaction_type, Status, Reason_code, Local_instrument, Reference_id, Trace_alert, Sourcetxntype, Alerttype, Feedback, Lock)
	}
