...
func Creditransferalertslogs(class, folder, Uniqueidcredittransfer string, message string, Instruction_id string, requestTrigger, Transaction_type string, Status string, Reason_code string, Local_instrument string, Reference_id string, Sender_bic string, Sender_name string, Sender_account string, Amount float64, Currency string, Receiving_bic string, Receiving_name string, Receiving_account string, Trace_alert string, Sourcetxntype string, Alerttype string) {
	currentTime := time.Now()
	...
	database.DBConn.Exec("SELECT * FROM trace_alerts.insert_logs_credittransfer(?,?,?,?,?,?,?,?,?,?,?,?)", Uniqueidcredittransfer, message, Trace_alert, Sourcetxntype, Transaction_type, Status, Reason_code, Local_instrument, Instruction_id, Reference_id, requestTrigger, Alerttype)

}

func Creditransferfeedbacklogs(class, folder, Uniqueidcredittransfer string, message string, Instruction_id string, requestTrigger string, Transaction_type string, Status string, Reason_code string, Local_instrument string, Reference_id string, Trace_alert string, Sourcetxntype string, Alerttype string, Feedback string) {
	currentTime := time.Now()
	...
	database.DBConn.Exec("SELECT * FROM trace_alerts.insert_logsfeedback_credittransfer(?,?,?,?,?,?,?,?,?,?,?,?,?)", Uniqueidcredittransfer, message, Trace_alert, Sourcetxntype, Transaction_type, Status, Reason_code, Local_instrument, Instruction_id, Reference_id, requestTrigger, Alerttype, Feedback)
